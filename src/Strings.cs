...
namespace BatteryChargeMeter
{
    ...
    internal static class Strings
    {
        ...
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>
        {
            ...
            { "60 秒峰值", "60s peak" },
            { "现在", "Now" },
            { "暂无有效采样", "No valid samples yet" },
            { "正在采样", "Collecting samples" },
            ...
            { "以当前 Windows 用户登录后，管理员权限运行并留在托盘。移动程序后需重新启用。", "Run elevated in the tray when this Windows user signs in. Enable again after moving the application." },
            ...
            { "已启用开机自启：登录后以管理员权限运行，在托盘显示。", "Startup enabled: run elevated in the tray at sign-in." },
